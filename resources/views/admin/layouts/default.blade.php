            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                    ...
                    <a class=" sidebar-brand brand-logo" style="color: white; text-decoration: none;" href="{{route('HomePage')}}">
                        <h3 style="color: #2f5687 !important">Chamba</h3>
                    </a>
                ...
                <i class="mdi mdi-account-multiple-plus"></i>
                        ...
                        <div class="collapse" id="ui-basic" style="">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a href="{{route('users_star')}}" class="nav-link" >Звёзды &nbsp;&nbsp; <span style="color: #2b4e84">{{\App\Models\User::where('star',  1)->count()}}</span> </a></li>
                                <li class="nav-item"> <a href="{{route('userss')}}" class="nav-link" >Пользователи &nbsp;&nbsp; <span style="color: #2b4e84">{{\App\Models\User::where('star', '!=', 1)->count()}}</span> </a></li>
                                <li class="nav-item"> <a href="{{route('users_black_list')}}" class="nav-link" >Заблокированные  &nbsp;&nbsp; <span style="color: #2b4e84">{{\App\Models\User::where('black_list_status',  1)->count()}}</span> </a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="{{route('all_post')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                            <span class="menu-title">Публикации &nbsp;&nbsp; <span style="color: #2b4e84"> {{\App\Models\Post::count()}}</span></span>
                        </a>
                    </li>
                </ul>
            </nav>
